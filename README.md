...
## ✅ Quick Wins
- [ ] Repo name **must** be `it23372726/it23372726`.
- [ ] Upload a banner to `assets/header-banner.png`.
- [ ] Ensure Actions are set up:
  - `metrics.yml` → writes `metrics/achievements.svg`
  - `contrib-3d.yml` → writes `profile-3d-contrib/*.svg`
- [ ] Pin **SkillLink**, **FitLifeHub**, **ml-labs** via GitHub UI (Profile → Customize your pins).
